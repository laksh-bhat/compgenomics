 ...
 */
public class TransactionalSequenceReadSpoutSpout implements ITridentSpout<Set<String>> {
    ...
    public TransactionalSequenceReadSpoutSpout (String singleOutputFieldName, String sourceFileName, String encoding) {
            ...
            if (reader != null) {
                try {
                    ...
                    System.err.println(MessageFormat.format("failed to close file from {0} => giving up...",
                                                            TransactionalSequenceReadSpoutSpout.class));
                    e.printStackTrace();
                }
            }
        }
